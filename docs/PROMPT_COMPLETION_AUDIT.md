...
| 3. Datos y provenance | Completo para v0.2 | 29 tablas SQLAlchemy, cuatro migraciones Alembic, claims append-only con URL/calidad congeladas y tests PostgreSQL | Materializar nuevas entidades sólo cuando existan adaptadores oficiales verificables |
